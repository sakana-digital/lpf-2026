...
export const semanticTokens = defineSemanticTokens({
  colors: {
    ...
    chart: {
      ...
      // Time since a save is not a series, so it stays grey and the picked group takes the accent.
      elapsed: { value: { base: 'oklch(100% 0 0 / 0.34)', _osLight: 'oklch(0% 0 0 / 0.28)' } },
    },
  },
})
